...
('Nestl�', 'Bebidas, L�cteos y Productos Frescos', 'Vicente L�pez 223', '0800-999-8100', '0800-999-8102', 'nestle.consultas@gmail.com' ),
...
('Cunnington' , 'Bebidas' , '-' , '-', '-', '-'),
('Coca-Cola' , 'Bebidas' , 'Av. Entre R�os 221' , '4567-0989', '4635-2843', 'coca.cola.company@gmail.com'),
...
(1,'AET78U9', 'https://http2.mlstatic.com/D_NQ_NP_792586-MLA47682120282_092021-O.webp' ,  'Agua de Mesa sin Gas Nestl� Bid�n 6.3L', 'Nestl�' ,'Bebidas', 'Agua' , 6.3 , 195.60 , 500 ),
...
-- CARNES Y PESCADOS
insert into productos(id_proveedor,codigo, imagen , nombre, marca, tipo, grupo, peso, precio_unidad, stock) values 
(8,'COPR8O6', 'https://d3ugyf2ht6aenh.cloudfront.net/stores/861/458/products/tapa-de-asado1-5eb3e89c1d76286a6815702030218736-480-0.jpg' ,'Tapa de Asado de Novillo x kg', 'Gen�rico' ,'Carnes y Pescados', 'Carne Vacuna' , 1.00 , 649.00 , 100 ),
(8,'HJ8R2O6', 'https://t2.rg.ltmcdn.com/es/images/8/7/0/img_medallones_de_pollo_33078_orig.jpg' , 'Medall�n de pollo rebozado crocante 400 g. x 4 uni', 'Gen�rico' ,'Carnes y Pescados', 'Pollo y Granja' , 0.400 , 369.00 , 100 ),
(8,'KJ8R2O3', 'https://calisa.com.ar/wp-content/uploads/2020/03/pollo_con_menudos.png' ,'Pollo entero congelado x kg.', 'Gen�rico' ,'Carnes y Pescados', 'Pollo y Granja' , 1.00 , 174.00 , 300 ),
(8,'JJ5R333', 'https://www.terravilena.es/wp-content/uploads/2019/11/cordero.jpg' ,'Cordero entero x kg.', 'Gen�rico' ,'Carnes y Pescados', 'Pollo y Granja' , 1.00 , 829.90 , 100 );
...
(8,'KLK1832', 'https://jumboargentina.vtexassets.com/arquivos/ids/339785-1200-auto?v=636439393168030000&width=1200&height=auto&aspect=true' ,'Medall�n de carne Swift receta especial reducido en grasas 4 u.', 'Swift' ,'Congelados', 'Hamburguesas' , 0.320 , 419.10 , 200 ),
...
insert into productos(id_proveedor,codigo, imagen, nombre, marca, tipo, grupo, peso, precio_unidad, stock) values
(8,'LL8JI9D', 'https://jumboargentina.vtexassets.com/arquivos/ids/641230-1200-auto?v=637557810525130000&width=1200&height=auto&aspect=true' ,'Leche Entera Larga Vida Ap�stoles 1L', 'Ap�stoles' ,'L�cteos y Productos Frescos', 'Leches' , 1.00 , 67.15 , 500 ),
(7,'LL8JI10', 'https://carrefourar.vtexassets.com/arquivos/ids/204565/7794710010406_02.jpg?v=637592985140930000' ,'Leche Entera uat Larclas tetra 1L', 'Larclas' ,'L�cteos y Productos Frescos', 'Leches' , 1.00 , 70.85 , 500 ),
(3,'HJA2234', 'https://arikiosco.tiendalite.com/images/products/500/86749394-1266.png' ,'Yogur bebible entero Sancor yogs mult. vainilla 1 l.', 'Sancor' ,'L�cteos y Productos Frescos', 'Yogures' , 1.00 , 226.80 , 300 ),
(3,'HJA2235', 'https://tunovo.com.ar/wp-content/uploads/7790080064223_01.jpg' ,'Yogur bebible entero Sancor yogs mult. frutilla 1 l.', 'Sancor' ,'L�cteos y Productos Frescos', 'Yogures' , 1.00 , 230.80 , 300 );
...
(8,'GHJ7711', 'https://http2.mlstatic.com/D_NQ_NP_914650-MLA31037009580_062019-O.webp' ,'Cebolla x kg', 'Gen�rico' ,'Frutas y Verduras', 'Verduras' , 1.00 , 48.00 , 300 ),
...
(8,'EEE8277', 'https://elegifruta.com.ar/onepage/wp-content/uploads/2017/07/manzana_roja.jpg' ,'Manzana roja x kg.', 'Gen�rico' ,'Frutas y Verduras', 'Frutas' , 1.00 , 159.00 , 100 );
...
, 'maca.gutieerez756@hotmail.com', 'Cajera', '2 a�os' , '2019/03/01', 45000),
('Damian', 'gutierrez', 39, '1978/09/14', 'DNI', '33869556', '20-33869556-3', 'Av Alberdi 05', '+5491176844456', '+5491157684445'
, 'damian_gut.756@gmail.com', 'Cajero', '3 a�os y 6 meses', '2018/3/4', 65000);
...
, 'marcosCastro2002_lop@hotmail.com', 'Repositor', '4 a�s', '2017/09/6', 70000),
...
, 'marcelocastro.746_jj@gmail.com', 'Gerente', '2 a�os y 5 meses', '2019/02/11', 120000);

-- Stack Tecnico
insert into empleados (nombre, apellido, edad, fecha_nac, tipo_doc, nro_doc, cuil, direccion
, nro_tel_princ, nro_tel_sec, email, cargo, antiguedad, fecha_ingreso, salario_anual) values
('Jos�', 'bastituta', 34, '1988/09/07', 'DNI', '409876546', '12409876546-0', 'San Acrosio 15781', '1157670000', '+5491157670000'
...
, 'c.gustamante@gmail.com', 'Admin Bases de Datos', '1 a�o y medio', '2019/12/02', 100000);
